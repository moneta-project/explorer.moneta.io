...
define( 'RPCPASS', 'GKPZjgKU67ddV5uc54PESFakyZmg51rphbEQqAGb8u94' );
...
echo '<table><tr><td><br/><br/><br/>Powered by <a href="http://moneta.io/" target="_blank">Moneta.io</a> v' . ACEVERSION . ' </td><td>Network hashrate: </td><td>' . $ace['hashrate_mhps'] . ' MH/s</td></tr><tr><td> </td><td></td><td></td></tr></table>';
echo '</div></body></html>'
?>
